...
class Minecraft:
    ...
    server_address: str = "smp.mummbleberry.com"
    rcon_host: str = os.getenv("MINECRAFT_RCON_HOST", "192.168.1.11")
    rcon_port: int = int(os.getenv("MINECRAFT_RCON_PORT", "25575"))
    rcon_password: str | None = os.getenv("MINECRAFT_RCON_PASSWORD")
